    ...
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 max-w-2xl">
          ...
          <h2 className="mt-3 font-heading text-4xl font-bold text-foreground sm:text-5xl">Previews listos para desbloquear</h2>
        </div>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5">
          {entradas.map((gradient, index) => (
            <div key={gradient} className="aspect-[3/4] overflow-hidden rounded-md border border-white/12 bg-white/[0.04] p-2">
              <div className={`relative h-full rounded-[6px] bg-gradient-to-br ${gradient}`}>
                ...
                <div className="absolute bottom-3 left-3 rounded-full bg-black/45 px-3 py-1 text-xs font-bold text-foreground backdrop-blur">
