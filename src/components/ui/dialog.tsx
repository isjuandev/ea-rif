  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 max-h-[min(92dvh,760px)] w-[calc(100vw-24px)] max-w-xl -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-md border border-white/15 bg-[#111111] p-4 text-foreground shadow-2xl shadow-lime-300/10 outline-none sm:p-5",
          className,
        )}
        {...props}
      >
